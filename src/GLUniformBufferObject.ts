...
export class GLUniformBufferObject {
    ...
    constructor(gl: WebGL2RenderingContext, bindPoint = 0, drawType: number = gl.DYNAMIC_DRAW) {
        this.gl = gl;
     ...
     * @param updateGL -
     */
    public updateItem(name: string, data: ArrayBuffer | ArrayBufferView, updateGL = false): void {
    ...
    public bindUBO(bindingPoint: number = this._bindingPoint, offset = 0, size: number = this._byteLength): void {
