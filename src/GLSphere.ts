...
export class GLSphere {
    ...
    constructor(gl: WebGL2RenderingContext, radius = 1, rings = 12, sectors = 12) {
        this.gl = gl;
    ...
    private createVertexData(radius: number, rings: number, sectors: number): void {
        ...
        const vertexData = new Float32Array(rings * sectors * 8);
        const indexData = new Uint32Array(rings * sectors * 6);
